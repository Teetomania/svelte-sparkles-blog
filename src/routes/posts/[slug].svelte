...
<script>
       ...
       const { title, date, tags, author: {name, authourTitle, picture}, content: {html}, coverImage} = post
</script>
<svelte:head>
...
<a href="/" class="inline-flex items-center mb-3">
    ...
    <span class="flex-grow flex flex-col pl-4">
        ...
        <span class="text-xs tracking-widest mt-0 5">{authourTitle}</span>
    </span>
</a>
<p class="text-xs tracking-widest font-semibold">
